...
| `AUTO_UNREGISTER` | | Whether to unregister the Runner from github.com when the container stops. <br />Default is `false`. It is recommended to map /home/runner/.runner_config <br />to a local volume when selecting false. <br />If mapped to a folder, permission issues may occur. |
...
services:
  actions-runner:
    ...
    volumes:
      - actions-runner-config:/home/runner/.runner_config
